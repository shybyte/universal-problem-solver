...
use universal_problem_solver_rs::example_problems::tetris4::{
    PuzzleProblem,
};
...
fn criterion_benchmark(c: &mut Criterion) {
    let mut group = c.benchmark_group("tetris4-4-5-pieces");
    ...
    let mut group_slow = c.benchmark_group("tetris4-10-pieces");
